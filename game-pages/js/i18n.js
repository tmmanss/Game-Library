(() => {
  const dict = {
    ...
    kk: {
      ...
      'status.valid': 'Деректер дұрыс (демо).','status.error': 'Өрістерді тексеріңіз.','status.sent': 'Жіберілді! Рахмет.','status.fail': 'Жіберу сәтсіз. Кейінірек қайталап көріңіз.',
      'ui.language': 'Тіл:'
    }
  };
  const apply = (lang) => {
  ...
  dict.kk = {
    ...
    'btn.submit': 'Жіберу',
    'btn.reset': 'Тазалау',
    'btn.subscribe': 'Жазылу',
    'status.valid': 'Деректер дұрыс (демо).',
    'status.error': 'Өрістерді тексеріңіз.',
    'status.sent': 'Жіберілді! Рақмет.',
    'status.fail': 'Жіберу сәтсіз. Кейінірек қайталап көріңіз.'
  };
